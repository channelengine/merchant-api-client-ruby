...
module ChannelEngineApiClient
  ...
  class MerchantOrderResponse
    ...
    def hash
      [id, channel_name, channel_order_support, channel_order_no, status, lines, phone, email, company_registration_no, vat_no, payment_method, shipping_costs_incl_vat, currency_code, order_date, channel_customer_no, billing_address, shipping_address, extra_data].hash
    end
