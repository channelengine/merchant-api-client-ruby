...
module ChannelEngineApiClient
  ...
  class ChannelReturnRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ChannelReference')
        self.channel_reference = attributes[:'ChannelReference']
      end
    ...
    def hash
      [channel_order_no, channel_reference, lines, reason, customer_comment, merchant_comment, refund_incl_vat, refund_excl_vat].hash
    end
