...
module ChannelEngineApiClient
  ...
  class MerchantShipmentRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'MerchantShipmentNo')
        self.merchant_shipment_no = attributes[:'MerchantShipmentNo']
      end
    ...
    def hash
      [merchant_shipment_no, merchant_order_no, lines, track_trace_no, track_trace_url, method].hash
    end
