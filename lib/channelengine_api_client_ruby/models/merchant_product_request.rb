...
module ChannelEngineApiClient
  ...
  class MerchantProductRequest
    ...
    def hash
      [merchant_product_no, parent_merchant_product_no, name, description, brand, size, color, ean, manufacturer_product_number, stock, price, msrp, purchase_price, vat_rate_type, shipping_cost, shipping_time, url, image_url, category_trail, extra_data].hash
    end
