...
module ChannelEngineMerchantApiClient
  class NotificationApi
    ...
    # @option opts [Array<String>] :types Notification type(s) to filter on
    ...
    # @option opts [Array<String>] :merchant_shipment_nos Filter on unique shipment reference used by the merchant
    # @option opts [Integer] :page The page to filter on. Starts at 1.
    # @return [Array<(CollectionOfMerchantNotificationResponse, Fixnum, Hash)>] CollectionOfMerchantNotificationResponse data, response status code and response headers
    def notification_index_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && opts[:'types'] && !opts[:'types'].all? { |item| ['FAILED_CONVERSION', 'FAILED_FEED_VALIDATION', 'INVALID_SETTING', 'MESSAGE', 'ORDER_CORRECTION', 'FAILED_ORDER_EXPORT', 'ORDER_OVERDUE', 'ORDER_DUPLICATE_LINES', 'ORDERS_ANONYMIZED_BY_REQUEST', 'ORDERS_ANONYMIZED_AUTOMATICALLY', 'RETURN_OVERDUE', 'FAILED_SHIPMENT_EXPORT', 'FAILED_RETURN_IMPORT', 'SUPPORT_NOTIFICATION', 'NEW_ORDER', 'NEW_RETURN', 'NEW_ORDER_CANCELLATION_REQUEST', 'FAILED_SHIPMENT_IMPORT', 'FAILED_RETURN_EXPORT'].include?(item) }
        fail ArgumentError, 'invalid value for "types", must include one of FAILED_CONVERSION, FAILED_FEED_VALIDATION, INVALID_SETTING, MESSAGE, ORDER_CORRECTION, FAILED_ORDER_EXPORT, ORDER_OVERDUE, ORDER_DUPLICATE_LINES, ORDERS_ANONYMIZED_BY_REQUEST, ORDERS_ANONYMIZED_AUTOMATICALLY, RETURN_OVERDUE, FAILED_SHIPMENT_EXPORT, FAILED_RETURN_IMPORT, SUPPORT_NOTIFICATION, NEW_ORDER, NEW_RETURN, NEW_ORDER_CANCELLATION_REQUEST, FAILED_SHIPMENT_IMPORT, FAILED_RETURN_EXPORT'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'CollectionOfMerchantNotificationResponse')
      if @api_client.config.debugging
