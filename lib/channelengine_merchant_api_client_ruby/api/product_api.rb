...
module ChannelEngineMerchantApiClient
  class ProductApi
    ...
    # @return [ApiResponse]
    def product_bulk_delete(opts = {})
      data, _status_code, _headers = product_bulk_delete_with_http_info(opts)
      data
    end
    ...
    def product_bulk_delete_with_http_info(opts = {})
    ...
    def product_create_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'merchant_product_request'])
