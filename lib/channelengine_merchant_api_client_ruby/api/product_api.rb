...
module ChannelEngineMerchantApiClient
  class ProductApi
    ...
    # @option opts [Array<MerchantProductRequest>] :merchant_product_request 
    # @return [SingleOfProductCreationResult]
    def product_create(opts = {})
      data, _status_code, _headers = product_create_with_http_info(opts)
      data
    end
    ...
    def product_create_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'merchant_product_request']) 

      # return_type
      return_type = opts[:return_type] || 'SingleOfProductCreationResult' 
    ...
    # @param merchant_product_no [String] 
    # @param [Hash] opts the optional parameters
    # @return [ApiResponse]
    ...
    def product_get_by_filter_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'CollectionOfMerchantProductResponse' 
    ...
    def product_get_by_merchant_product_no_with_http_info(merchant_product_no, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'SingleOfMerchantProductResponse' 
    ...
    def product_patch_with_http_info(merchant_product_no, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'operation']) 
