...
module ChannelEngineMerchantApiClient
  class StockLocationApi
    ...
    # @option opts [MerchantStockLocationCreateRequest] :merchant_stock_location_create_request 
    # @return [ApiResponse]
    def stock_location_create(opts = {})
      data, _status_code, _headers = stock_location_create_with_http_info(opts)
      data
    end
    ...
    def stock_location_create_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StockLocationApi.stock_location_create ...'
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'merchant_stock_location_create_request'])
      ...
      new_options = opts.merge(
        :operation => :"StockLocationApi.stock_location_create",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StockLocationApi#stock_location_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
