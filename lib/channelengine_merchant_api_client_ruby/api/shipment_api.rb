...
module ChannelEngineMerchantApiClient
  class ShipmentApi
    ...
    def shipment_create_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'merchant_shipment_request']) 
    ...
    def shipment_create_for_channel_method_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'merchant_channel_label_shipment_request']) 
    ...
    def shipment_get_shipment_label_carriers_with_http_info(merchant_order_no, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'merchant_shipment_label_carrier_request']) 
    ...
    def shipment_update_with_http_info(merchant_shipment_no, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'merchant_shipment_tracking_request']) 
