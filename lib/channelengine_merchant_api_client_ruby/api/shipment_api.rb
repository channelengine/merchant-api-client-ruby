...
module ChannelEngineMerchantApiClient
  class ShipmentApi
    ...
    # @option opts [Time] :from_date Filter on the shipment date, starting from this date. This date is inclusive.
    # @option opts [Time] :to_date Filter on the shipment date, until this date. This date is exclusive.
