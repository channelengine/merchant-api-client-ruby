...
module ChannelEngineMerchantApiClient
  class OfferApi
    ...
    def offer_get_stock_with_http_info(skus, stock_location_ids, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'CollectionOfMerchantOfferGetStockResponse' 
    ...
    def offer_stock_price_update_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(opts[:'merchant_stock_price_update_request']) 

      # return_type
      return_type = opts[:return_type] || 'SingleOfDictionaryOfStringAndListOfString' 
