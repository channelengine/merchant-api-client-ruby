...
module ChannelEngineMerchantApiClient
  class MerchantShipmentResponse
    ...
    attr_accessor :channel_shipment_no
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'channel_shipment_no')
        self.channel_shipment_no = attributes[:'channel_shipment_no']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          channel_shipment_no == o.channel_shipment_no &&
    ...
    def hash
      [merchant_shipment_no, merchant_order_no, channel_shipment_no, channel_order_no, lines, created_at, updated_at, extra_data, track_trace_no, track_trace_url, return_track_trace_no, method, shipped_from_country_code, shipment_date].hash
    end
