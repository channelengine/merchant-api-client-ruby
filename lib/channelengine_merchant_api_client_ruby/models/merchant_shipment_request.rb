...
module ChannelEngineMerchantApiClient
  class MerchantShipmentRequest
    ...
    def hash
      [merchant_shipment_no, merchant_order_no, lines, extra_data, track_trace_no, track_trace_url, return_track_trace_no, method, shipped_from_country_code, shipment_date].hash
    end
