...
module ChannelEngineMerchantApiClient
  ...
  class MerchantCancellationRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'MerchantCancellationNo')
        self.merchant_cancellation_no = attributes[:'MerchantCancellationNo']
      end
    ...
    def valid?
      ...
      reason_code_validator = EnumAttributeValidator.new('String', ["NOT_IN_STOCK", "DAMAGED", "INCOMPLETE", "CLIENT_CANCELLED", "INVALID_ADDRESS", "OTHER"])
    ...
    def reason_code=(reason_code)
      validator = EnumAttributeValidator.new('String', ["NOT_IN_STOCK", "DAMAGED", "INCOMPLETE", "CLIENT_CANCELLED", "INVALID_ADDRESS", "OTHER"])
