...
module ChannelEngineMerchantApiClient
  class MerchantSingleOrderReturnResponse
    ...
    def hash
      [merchant_order_no, lines, created_at, updated_at, merchant_return_no, channel_return_no, channel_id, global_channel_id, global_channel_name, status, id, reason, customer_comment, merchant_comment, refund_incl_vat, refund_excl_vat, return_date].hash
    end
