...
module ChannelEngineMerchantApiClient
  class NotificationType
    ...
    TRANSLATION_IMAGE_TAGS_BROKEN = "TRANSLATION_IMAGE_TAGS_BROKEN".freeze
    ...
    TRANSLATION_FAILED = "TRANSLATION_FAILED".freeze
    ORDER_CANNOT_BE_FULFILLED = "ORDER_CANNOT_BE_FULFILLED".freeze
