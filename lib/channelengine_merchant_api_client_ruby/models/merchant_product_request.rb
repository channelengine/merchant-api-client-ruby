  ...
  class MerchantProductRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ChannelEngineMerchantApiClient::MerchantProductRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ChannelEngineMerchantApiClient::MerchantProductRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'parent_merchant_product_no')
        self.parent_merchant_product_no = attributes[:'parent_merchant_product_no']
      end

      if attributes.key?(:'parent_merchant_product_no2')
        self.parent_merchant_product_no2 = attributes[:'parent_merchant_product_no2']
      end
    ...
    def list_invalid_properties
      ...
      if !@parent_merchant_product_no.nil? && @parent_merchant_product_no.to_s.length > 64
        invalid_properties.push('invalid value for "parent_merchant_product_no", the character length must be smaller than or equal to 64.')
      end

      if !@parent_merchant_product_no.nil? && @parent_merchant_product_no.to_s.length < 0
        invalid_properties.push('invalid value for "parent_merchant_product_no", the character length must be great than or equal to 0.')
      end

      if !@parent_merchant_product_no2.nil? && @parent_merchant_product_no2.to_s.length > 64
        invalid_properties.push('invalid value for "parent_merchant_product_no2", the character length must be smaller than or equal to 64.')
      end

      if !@parent_merchant_product_no2.nil? && @parent_merchant_product_no2.to_s.length < 0
        invalid_properties.push('invalid value for "parent_merchant_product_no2", the character length must be great than or equal to 0.')
      end
    ...
    def valid?
      return false if !@parent_merchant_product_no.nil? && @parent_merchant_product_no.to_s.length > 64
      return false if !@parent_merchant_product_no.nil? && @parent_merchant_product_no.to_s.length < 0
      return false if !@parent_merchant_product_no2.nil? && @parent_merchant_product_no2.to_s.length > 64
      return false if !@parent_merchant_product_no2.nil? && @parent_merchant_product_no2.to_s.length < 0
    ...
    # @param [Object] parent_merchant_product_no Value to be assigned
    def parent_merchant_product_no=(parent_merchant_product_no)
      if !parent_merchant_product_no.nil? && parent_merchant_product_no.to_s.length > 64
        fail ArgumentError, 'invalid value for "parent_merchant_product_no", the character length must be smaller than or equal to 64.'
      end

      if !parent_merchant_product_no.nil? && parent_merchant_product_no.to_s.length < 0
        fail ArgumentError, 'invalid value for "parent_merchant_product_no", the character length must be great than or equal to 0.'
      end

      @parent_merchant_product_no = parent_merchant_product_no
    end

    # Custom attribute writer method with validation
    # @param [Object] parent_merchant_product_no2 Value to be assigned
    def parent_merchant_product_no2=(parent_merchant_product_no2)
      if !parent_merchant_product_no2.nil? && parent_merchant_product_no2.to_s.length > 64
        fail ArgumentError, 'invalid value for "parent_merchant_product_no2", the character length must be smaller than or equal to 64.'
      end

      if !parent_merchant_product_no2.nil? && parent_merchant_product_no2.to_s.length < 0
        fail ArgumentError, 'invalid value for "parent_merchant_product_no2", the character length must be great than or equal to 0.'
      end

      @parent_merchant_product_no2 = parent_merchant_product_no2
    end
