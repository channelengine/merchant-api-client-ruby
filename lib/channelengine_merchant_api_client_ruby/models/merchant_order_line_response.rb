...
module ChannelEngineMerchantApiClient
  ...
  class MerchantOrderLineResponse
    ...
    def hash
      [status, is_fulfillment_by_marketplace, merchant_product_no, unit_vat, line_total_incl_vat, line_vat, original_unit_price_incl_vat, original_unit_vat, original_line_total_incl_vat, original_line_vat, channel_product_no, quantity, unit_price_incl_vat, fee_fixed, fee_rate, condition].hash
    end
