...
module ChannelEngineMerchantApiClient
  class MerchantOrderLineResponse
    ...
    attr_accessor :juris_code

    # Name of a tax jurisdiction.
    attr_accessor :juris_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ChannelEngineMerchantApiClient::MerchantOrderLineResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ChannelEngineMerchantApiClient::MerchantOrderLineResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'juris_code')
        self.juris_code = attributes[:'juris_code']
      end

      if attributes.key?(:'juris_name')
        self.juris_name = attributes[:'juris_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          juris_code == o.juris_code &&
          juris_name == o.juris_name &&
          vat_rate == o.vat_rate &&
    ...
    def hash
      [status, is_fulfillment_by_marketplace, gtin, description, stock_location, unit_vat, line_total_incl_vat, line_vat, original_unit_price_incl_vat, original_unit_vat, original_line_total_incl_vat, original_line_vat, original_fee_fixed, bundle_product_merchant_product_no, juris_code, juris_name, vat_rate, extra_data, channel_product_no, merchant_product_no, quantity, cancellation_requested_quantity, unit_price_incl_vat, fee_fixed, fee_rate, condition, expected_delivery_date].hash
    end
