...
module ChannelEngineMerchantApiClient
  class MerchantOrderLineResponse
    ...
    def hash
      [status, is_fulfillment_by_marketplace, merchant_product_no, gtin, description, unit_vat, line_total_incl_vat, line_vat, original_unit_price_incl_vat, original_unit_vat, original_line_total_incl_vat, original_line_vat, original_fee_fixed, bundle_product_merchant_product_no, extra_data, channel_product_no, quantity, cancellation_requested_quantity, unit_price_incl_vat, fee_fixed, fee_rate, condition, expected_delivery_date].hash
    end
