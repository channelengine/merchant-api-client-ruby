...
module ChannelEngineMerchantApiClient
  class MerchantReturnResponse
    ...
    def hash
      [merchant_order_no, channel_order_no, channel_id, global_channel_id, global_channel_name, lines, created_at, updated_at, merchant_return_no, channel_return_no, id, reason, customer_comment, merchant_comment, refund_incl_vat, refund_excl_vat].hash
    end
