...
# Unit tests for ChannelEngineApiClient::ApiResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApiResponse' do
  before do
    # run before each test
    @instance = ChannelEngineApiClient::ApiResponse.new
  end
  ...
  describe 'test an instance of ApiResponse' do
    it 'should create an instance of ApiResponse' do
      expect(@instance).to be_instance_of(ChannelEngineApiClient::ApiResponse)
    end
  end
